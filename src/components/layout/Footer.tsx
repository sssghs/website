    ...
    <footer className="bg-school-navy text-white pt-16 pb-8 relative z-10">
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-school-navy font-serif font-bold text-lg">I</span>
              </div>
              <h3 className="font-serif font-bold text-xl">Inspire - The Holistic School</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/80">123 Education Ave, Scholarlane, SL 12345</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={20} className="text-school-gold flex-shrink-0" />
                <a href="tel:+1234567890" className="text-white/80 hover:text-white transition-colors duration-200">+1(234)567-890</a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={20} className="text-school-gold flex-shrink-0" />
                <a href="mailto:inspiretheholisticschool@gmail.com" className="text-white/80 hover:text-white transition-colors duration-200">inspiretheholisticschool@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-white/60 relative text-sm">
          <p className="text-center">© {currentYear} Inspire - The Holistic School. All Rights Reserved.</p>
